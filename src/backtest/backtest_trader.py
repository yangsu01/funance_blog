...
class BacktestTrader:
    ...
    def _calculate_performance(self, price_data: pd.Series):
    ...
    def _stationary_bootstrap(self, initial_price: float, returns_data: pd.Series, n_iterations: int, block_size: int):
    ...
    def _calculate_stats(self, returns_data: pd.Series):
    ...
    def run_bootstrap(self, n_iterations: int=1000, block_size: int=10):
